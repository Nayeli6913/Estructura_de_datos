...
class Traductor
{
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            string? input = Console.ReadLine();   // ← string? en lugar de string
    ...
    static void TraducirFrase(Dictionary<string, string> diccionario)
    {
        ...
        string? frase = Console.ReadLine();   // ← puede ser null

        if (string.IsNullOrWhiteSpace(frase))   // ← validamos null o vacío
        {
    ...
    static void AgregarPalabra(Dictionary<string, string> diccionario)
    {
        ...
        {
            diccionario[espanol.ToLower()] = ingles;  // ← guardar en minúscula para uniformidad
